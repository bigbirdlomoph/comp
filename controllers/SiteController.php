...
class SiteController extends Controller
{
    ...
    public function actionCio()
    {
        return $this->render('cio');
    }
    
    public function actionPricecctv()
    {
        return $this->render('pricecctv');
    }

    public function actionComform()
    {
        return $this->render('comform');
    }
