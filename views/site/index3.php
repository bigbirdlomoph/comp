...
use yii\helpers\Url;
$this->title = 'คณะกรรมการจัดหาระบบคอมฯ';
?>
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <div >
            <h2 class="tsb f30p">คณะกรรมการจัดหาระบบคอมพิวเตอร์ภาครัฐฯ<br> <small class="lead tsb">สำนักงานสาธารณสุขจังหวัดเลย</small></h2>
            <hr>
        </div>
    ...
    <div class="body-content">
        <!-- computer -->
        <div class="list-group tssb f20p col-sm-6">
