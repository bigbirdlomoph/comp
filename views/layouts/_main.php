...
<div class="wrap">
    ...
    //$rpt_menu_g1[] = ['label' => '<i class="fa fa-desktop" style="color:blue;"></i>
    //             เกณฑ์ราคากลางครุภัณฑ์คอมฯ ปี 2560', 'url' => ['/site/pricebasic']];
    //$rpt_menu_g1[] = ['label' => '<i class="fa fa-file-word-o"></i>
    //             แบบฟอร์มการจัดหา', 'url' => ['/site/docs']]; 
    //End Menu group 1
    
    //Start Menu group 2 CCTV
    $rpt_menu_g2[] = ['label' => '<i class="fa fa-book" style="color:blue;"></i> 
                หลักเกณฑ์ & แนวทางการจัดหา', 'url' => ['/site/resolution']];
    $rpt_menu_g2[] = ['label' => '<i class="fa fa-users"></i> 
                CIO สสจ.', 'url' => ['/site/cio']];
    //$rpt_menu_g2[] = ['label' => '<i class="fa fa-video-camera"></i>
    //             คุณลักษณะ CCTV', 'url' => ['/site/pricecctv']];
    //$rpt_menu_g2[] = ['label' => '<i class="fa fa-file-word-o"></i>
    //             แบบฟอร์มการจัดหา', 'url' => ['/site/docs']];
    //End Menu group 2
